...
namespace BPR
{
    ...
    class Program
    {
        ...
        private async Task HandleCommandAsync(SocketMessage messageParam)
        {
            ...
            if (message.Channel.Id != 392829581192855554 && message.Channel.Id != 422045385612328973 && message.Channel.Id != 410988141491519488 && message.Channel.Id != 439177902035173389 && message.Channel.Id != 439177928182595586) return;
