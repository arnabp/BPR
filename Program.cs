...
namespace BPR
{
    ...
    class Program
    {
        ...
        private async Task HandleCommandAsync(SocketMessage messageParam)
        {
            ...
            if (message.Channel.Id != 392829581192855554 && message.Channel.Id != 422045385612328973 && message.Channel.Id != 410988141491519488 && message.Channel.Id != 438946129732960257 && message.Channel.Id != 438946013814718464) return;
