                ...
                while (reader.Read())
                {
                        ...
                        reader.GetUInt64(3) == id)
                    {
                        MatchHistory matchHistory = new MatchHistory
                        {
                            ...
                            id3 = reader.GetUInt64(2),
                            id4 = reader.GetUInt64(3),
                            revert1 = reader.GetBoolean(8),
                            revert2 = reader.GetBoolean(9),
                            revert3 = reader.GetBoolean(10),
                            revert4 = reader.GetBoolean(11),
                            oldScore1 = reader.GetInt16(12),
                            oldScore2 = reader.GetInt16(13),
                            oldScore3 = reader.GetInt16(14),
                            oldScore4 = reader.GetInt16(15),
                            oldStreak1 = reader.GetInt16(16),
                            oldStreak2 = reader.GetInt16(17),
                            oldStreak3 = reader.GetInt16(18),
                            oldStreak4 = reader.GetInt16(19),
                            isReporterWinner = reader.GetBoolean(20),
                            reporter = reader.GetUInt64(21)
                        };
                        return matchHistory;
                    }
                }
