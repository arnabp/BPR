...
namespace BPR
{
    ...
    public class Queue1Module : ModuleBase<SocketCommandContext>
    {
        ...
        public async Task JoinAsync()
        {
            ...
            if (Context.Guild.Id == 392829581192855552 || Context.Guild.Id == 422045385612328970 || Context.Guild.Id == 410984826800177154)
            {
    ...
    public class Queue2Module : ModuleBase<SocketCommandContext>
    {
        ...
        private async Task NewMatch(int p1, int p2, int p3, int p4, string region)
        {
            ...
            string query = $"SELECT time, username, id FROM queue{region}2;";
            await Globals.conn.OpenAsync();
            try
            {
                MySqlCommand cmd = new MySqlCommand(query, Globals.conn);
